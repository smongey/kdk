...
<?php foreach($pages->find('projects')->builder()->toStructure() as $section): ?>
	...
	<?php if ($section->_fieldset() == "single" ) {?>
		...
		<li>
			<picture>
				<img src="<?php echo $pages->find('projects')->image($section->image())->url() ?>" alt="<?php echo $section->caption() ?>">
		    </picture>
	...
	<?php } elseif ($section->_fieldset() == "double" ) { ?>
		...
		<li>
			<picture>
				<img src="<?php echo $pages->find('projects')->image($section->image1())->url() ?>" alt="<?php echo $section->caption1() ?>">
		    </picture>
			<p class="caption"><?php echo $section->caption1() ?></p>
		</li>
		<li>
			<picture>
				<img src="<?php echo $pages->find('projects')->image($section->image2())->url() ?>" alt="<?php echo $section->caption2() ?>">
		    </picture>
	...
	<?php } else { ?>
		...
		<li>
			<picture>
				<img src="<?php echo $pages->find('projects')->image($section->image3())->url() ?>" alt="<?php echo $section->caption3() ?>">
		    </picture>
