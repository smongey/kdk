	...
	<div class="full two">
		...
		<div class="half view">
			<picture>
				<source media="(max-width: 480px)" data-srcset="<?php echo $xs1->url() ?> 1x, <?php echo $s1->url() ?> 2x">
				<source media="(max-width: 800px)" data-srcset="<?php echo $m1->url() ?> 1x, <?php echo $l1->url() ?> 2x">
				<source media="(max-width: 1200px)" data-srcset="<?php echo $xl1->url() ?>, <?php echo $xxl1->url() ?> 2x">
				<img data-slide="3" src="assets/images/loading.gif" class="lazyload" data-src="<?php echo $xl1->url() ?>" alt="<?php echo $section->caption() ?>">
			</picture>
		</div>
		
		<div class="half view">
			<picture>
				<source media="(max-width: 480px)" data-srcset="<?php echo $xs2->url() ?> 1x, <?php echo $s2->url() ?> 2x">
				<source media="(max-width: 800px)" data-srcset="<?php echo $m2->url() ?> 1x, <?php echo $l2->url() ?> 2x">
				<source media="(max-width: 1200px)" data-srcset="<?php echo $xl2->url() ?>, <?php echo $xxl2->url() ?> 2x">
				<img data-slide="3" src="assets/images/loading.gif" class="lazyload" data-src="<?php echo $xl2->url() ?>" alt="<?php echo $section->caption() ?>">
			</picture>
		</div>
	</div>